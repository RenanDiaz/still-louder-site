...
export const EVENT = {
  ...
  // La preventa abre el 15 de junio al mediodía: el countdown apunta aquí y el
  // formulario de compra permanece oculto hasta esta hora (cliente y servidor).
  presaleStart: '2026-06-15T12:00:00-05:00',
